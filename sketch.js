...
function setup() {
	...
	bob1 = new Bob(width/2-80,400,30);
	bob2 = new Bob(width/2-40,400,30);
	bob3 = new Bob(width/2,400,30);
	bob4 = new Bob(width/2+40,400,30);
	bob5 = new Bob(width/2+80,400,30);
...
function draw() {
 ...
 function keyPressed(){
	 if(keyCode === UP_ARROW){
		 Matter.Body.applyForce(bob1.body,bob1.body.positionX,{x: -250,y: 100});
	 }
 }
